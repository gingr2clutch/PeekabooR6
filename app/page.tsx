              ...
              return (
                <li key={map.id} data-reveal style={revealStyle}>
                  ...
                  >
                    {cover}
                    {isNewMap && (
                      <span className="absolute right-2 top-2 z-20 inline-flex items-center rounded-btn bg-teal px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white shadow-sm">
                        New map
                      </span>
                    )}
                    {label}
