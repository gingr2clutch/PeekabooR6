...
// Filled orange CTA matching RandomPeekButton / GearUp. Opens the permanent
// Discord invite in a new tab. Used in the site nav (desktop + mobile drawer)
// and near the top of the map page.
