...
export function AnnouncementBanner() {
  ...
  return (
    <div className="relative mx-auto mb-6 max-w-3xl overflow-hidden rounded-card bg-gradient-to-r from-purple-600 via-fuchsia-500 to-brand text-white shadow-[0_4px_16px_rgba(168,85,247,0.25)]">
      ...
      <div className="relative flex items-center gap-3 px-3 py-2.5 sm:gap-4 sm:px-4 sm:py-3">
        ...
        <span className="min-w-0 flex-1 text-[13px] font-semibold leading-snug drop-shadow-sm sm:text-sm">
        ...
        <button
          ...
          className="-mr-1 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-btn text-white/80 transition-colors hover:bg-white/15 hover:text-white"
        >
          <svg
            viewBox="0 0 24 24"
            width="14"
...
function PinGlyph() {
  return (
    <span
      aria-hidden
      className="relative inline-flex h-7 w-7 shrink-0 items-center justify-center drop-shadow-sm"
    >
      <svg
        viewBox="0 0 24 24"
      ...
      <svg
        viewBox="0 0 24 24"
        className="relative h-3 w-3 -translate-y-[3px] fill-purple-700"
      >
